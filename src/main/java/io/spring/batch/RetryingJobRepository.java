 ...
 */
public class RetryingJobRepository implements JobRepository {
	 ...
	 */
	RetryingJobRepository() {
	}

	public RetryingJobRepository(JobInstanceDao jobInstanceDao, JobExecutionDao jobExecutionDao,
	...
	public JobExecution createJobExecution(String jobName, JobParameters jobParameters)
		...
		if (jobInstance != null) {
			...
			try {
				jobInstance = this.retryTemplate.execute((RetryCallback<JobInstance, Throwable>) context -> jobInstanceDao.createJobInstance(jobName, jobParameters));
			}
			catch (Throwable throwable) {
				System.out.println(">> This was an unsuccessful insert...WTF?");
...
//			jobInstance = jobInstanceDao.createJobInstance(jobName, jobParameters);
	...
	public void add(StepExecution stepExecution) {
		...
		try {
			this.retryTemplate.execute(new RetryCallback<Void, Throwable>() {
				@Override
